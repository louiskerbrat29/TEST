---
name: remotion
description: Reference guide for building and editing Remotion video apps (React-based video rendering). Use when creating, editing, or rendering videos with Remotion — compositions, Sequence/Series/TransitionSeries, useCurrentFrame, interpolate, spring, OffthreadVideo, Audio, Img, Gif, staticFile.
---
